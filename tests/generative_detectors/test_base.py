...
def test_content_analysis_invalid_detection_object(detection_base):
    ...
    with (
        ...
        patch(
            ...
            side_effect=lambda response, scores, detection_type, metadata: (
                "dummy_processed_response",
                "dummy_processed_scores",
                "dummy_processed_type",
                "dummy_processed_metadata",
            ),
        ),
        patch(
